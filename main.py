...
@app.route("/")
def home():
    # flash("Welcome To My Channel", "success")
    # flash("COVID-19 alert - STAY HOME, STAY SAFE", "danger")
...
def contact():
    if request.method == 'POST':
        ...
        flash("Thanks for submitting your details. We will get back back to you soon.", "success")
